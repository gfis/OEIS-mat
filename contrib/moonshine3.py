...
# Downloaded from:
# http://www.madore.org/~david/programs/#prog_moonshine
# David A. Madore <david.madore@ens.fr> - 2007-07-31 - Public Domain
# 2020-09-17, Georg Fischer <dr.georg.fischer@gmail.com>: Converted to Python3
...
class PowerSeries(BaseException):
