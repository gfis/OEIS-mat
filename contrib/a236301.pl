#!perl
# 2020-03-11, Georg Fischer
my $buffer = "";
while (<DATA>) {
	$buffer .= $_;
}
my @terms = split(/\D+/, $buffer);
my $ind = 1;
print <<"GFis";
# A236301 Al-Antaakii's 15 X 15 magic square read by rows.
# Table of n, a(n) for n = 1..225
# Extracted from example by Georg Fischer, Mar 11 2020
GFis
