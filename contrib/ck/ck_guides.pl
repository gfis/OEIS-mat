...
my %U_forms = (
    "-1+2^h",       "new A000225()"                            ,
    "1+[h/2]",      "new A008619()"                            ,
    "2*h-1",        "new PrependSequence(new A005408(), 0)"    ,
    "2^(h-1)",      "new A131577()"                            ,
    "2^(n-1)",      "new A131577()"                            ,
    "3*h-1",        "new PrependSequence(new A016789(), 0)"    ,
    "3*h-2",        "new PrependSequence(new A016777(), 0)"    ,
    "4*h-1",        "new PrependSequence(new A004767(), 0)"    ,
    "4*h-3",        "new PrependSequence(new A016813(), 0)"    ,
    "C(2*h-2,h-1)", "new PrependSequence(new A000984(), 0)"    ,
    "Fibo(h)",      "new A000045()"                            ,
    "Fibo(h+1)",    "new SkipSequence(new A000045(), 1)"       ,
    "Fibo(n+1)",    "new SkipSequence(new A000045(), 1)"       ,
    "[(h+1)/2]",    "new A110654()"                            ,
    "h",            "new A001477()"                            ,
    "h*(h+1)/2",    "new A000217()"                            ,
    "h^2",          "new A000290()"                            ,
...
while (<DATA>) {
    ...
    if ($line =~ m{\A\=(\w)\=}) {
        ...
        if ($opt !~ m{[$asel]}) {
            ...
            my ($form1, $form2);
            ($opt, $form1, $form2, @ans) = split(/\s+/, $line);
            @ans = map { (m{\AA\d+\Z}) ? $_ : "nnnn" } @ans;
            $offset = 1;
            $form1 =~ s/[ \.]//g;
            $form2 =~ s/[ \.]//g;
            ...
            my $i = 0;
            &outstd($ans[$i ++], ("A205558", $hash{$opt}, $c, 1));
            &outstd($ans[$i ++], ("A205558", $hash{$opt}, $c, 2));
            &outstd($ans[$i ++], ("A205558", $hash{$opt}, $c, 3));
            ...
            #=b=    r...... A000045 A000045 A000045 A000045..r
            my $c;
            ($opt, $c, @ans) = split(/\s+/, $line);
            @ans = map { (m{\AA\d+\Z}) ? $_ : "nnnn" } @ans;
            $offset = 1;
            ...
            $c =~ s{\AS\(5\)}{CR.FIVE.sqrt()}g;
            $c =~ s{(\d+)\+S\((\d+)\)}{CR.valueOf($1).add(CR.valueOf($2).sqrt())}g;
            my $ok = 1;
            $callcode = "parm3";
            my $i = 0;
            &outstd($ans[$i ++], ("A214999", 1, $c));
            &outstd($ans[$i ++], ("A214999", 2, $c));
            &outstd($ans[$i ++], ("A214999", 3, $c));
            &outstd($ans[$i ++], ("A214999", 4, $c));
        } else { # unknown -a
        }
    } # line with =opt=
} # while <DATA>
...
=U=	h...........	h...........	A213500	A002412	A002415
=U=	h...........	h^2.........	A212891	A213436	A024166
=U=	h^2.........	h...........	A213503	A117066	A033455
=U=	h^2.........	h^2.........	A213505	A213546	A213547
=U=	h...........	h*(h+1)/2...	A213548	A213549	A051836
=U=	h*(h+1)/2...	h...........	A213550	A002418	A005585
=U=	h*(h+1)/2...	h*(h+1)/2...	A213551	A213552	A051923
=U=	h...........	h^3.........	A213553	A213554	A101089
=U=	h^3.........	h...........	A213555	A213556	A213547
=U=	h^3.........	h^3.........	A213558	A213559	A213560
=U=	h^2.........	h*(h+1)/2...	A213561	A213562	A213563
=U=	h*(h+1)/2...	h^2.........	A213564	A213565	A101094
=U=	2^(h-1).....	h...........	A213568	A213569	A047520
=U=	2^(h-1).....	h^2.........	A213573	A213574	A213575
=U=	h...........	Fibo(h).....	A213576	A213577	A213578
=U=	Fibo(h).....	h...........	A213579	A213580	A053808
=U=	Fibo(h).....	Fibo(h).....	A067418	A027991	A067988
=U=	Fibo(h+1)...	h...........	A213584	A213585	A213586
=U=	Fibo(n+1)...	Fibo(h+1)...	A213587	A213588	A213589
=U=	h^2.........	Fibo(h).....	A213590	A213504	A213557
=U=	Fibo(h).....	h^2.........	A213566	A213567	A213570
=U=	h...........	-1+2^h......	A213571	A213572	A213581
=U=	-1+2^h......	h...........	A213582	A213583	A156928
=U=	-1+2^h......	-1+2^h......	A213747	A213748	A213749
=U=	h...........	2*h-1.......	A213750	A007585	A002417
=U=	2*h-1.......	h...........	A213751	A051662	A006325
=U=	2*h-1.......	2*h-1.......	A213752	A100157	A071238
=U=	2*h-1.......	-1+2^h......	A213753	A213754	A213755
=U=	-1+2^h......	2*h-1.......	A213756	A213757	A213758
=U=	2^(n-1).....	2*h-1.......	A213762	A213763	A213764
=U=	2*h-1.......	Fibo(h).....	A213765	A213766	A213767
=U=	Fibo(h).....	2*h-1.......	A213768	A213769	A213770
=U=	Fibo(h+1)...	2*h-1.......	A213774	A213775	A213776
=U=	Fibo(h).....	Fibo(h+1)...	A213777	A001870	A152881
=U=	h...........	1+[h/2].....	A213778	A213779	A213780
=U=	1+[h/2].....	h...........	A213781	A213782	A005712
=U=	1+[h/2].....	[(h+1)/2]...	A213783	A213759	A213760
=U=	h...........	3*h-2.......	A213761	A172073	A002419
=U=	3*h-2.......	h...........	A213771	A213772	A132117
=U=	3*h-2.......	3*h-2.......	A213773	A214092	A213818
=U=	h...........	3*h-1.......	A213819	A213820	A153978
=U=	3*h-1.......	h...........	A213821	A033431	A176060
=U=	3*h-1.......	3*h-1.......	A213822	A213823	A213824
=U=	3*h-1.......	3*h-2.......	A213825	A213826	A213827
=U=	3*h-2.......	3*h-1.......	A213828	A213829	A213830
=U=	2*h-1.......	3*h-2.......	A213831	A213832	A212560
=U=	3*h-2.......	2*h-1.......	A213833	A130748	A213834
=U=	h...........	4*h-3.......	A213835	A172078	A051797
=U=	4*h-3.......	h...........	A213836	A213837	A071238
=U=	4*h-3.......	2*h-1.......	A213838	A213839	A213840
=U=	2*h-1.......	4*h-3.......	A213841	A213842	A213843
=U=	2*h-1.......	4*h-1.......	A213844	A213845	A213846
=U=	4*h-1.......	2*h-1.......	A213847	A213848	A180324
=U=	[(h+1)/2]...	[(h+1)/2]...	A213849	A049778	A213850
=U=	h...........	C(2*h-2,h-1)	A213853	none	none
#--------------------------------
# A205558
=V=	2	A133196	A131818	nnnn	nnnn	A204898	A205558
=V=	3	A205560	A205547	A205673	A205674	A205557	A205675
=V=	4	A205677	A205678	A205679	A205680	A205681	A205682
=V=	5	A205684	A205685	A205686	A205687	A205688	A205689
=V=	6	A205691	A205692	A205693	A205694	A205695	A205696
=V=	7	A205698	A205699	A205700	A205701	A205702	A205703
=V=	8	A205705	A205706	A205707	A205708	A205709	A205710
=V=	9	A205712	A205713	A205714	A205715	A205716	A205717
=V=	10	A205720	A205721	A205722	A205723	A205724	A205725
#--------------------------------
# A205840
#.. c...k.......j.......               (k)-s(j)..[s(k)-s(j)]/c
=W=	2	A205837	A205838	nnnn	nnnn	A205839	A205840
=W=	3	A205842	A205843	nnnn	nnnn	A205844	A205845
=W=	4	A205847	A205848	nnnn	nnnn	A205849	A205850
=W=	5	A205852	A205853	nnnn	nnnn	A205854	A205855
=W=	6	A205857	A205858	nnnn	nnnn	A205859	A205860
=W=	7	A205862	A205863	nnnn	nnnn	A205864	A205865
=W=	8	A205867	A205868	nnnn	nnnn	A205869	A205870
=W=	9	A205872	A205873	nnnn	nnnn	A205874	A205875
...
# A197032
#   m...h...k. x-intercept distance
=a=	1	2	1	A197032	A197033	2.3
=a=	1	3	1	A197034	A197035	3.4
=a=	1	4	1	A197136	A197137	4.5
=a=	1	3	2	A197138	A197139	3.4
=a=	2	1	1	A197140	A197141	1.4
=a=	2	2	1	A197142	A197143	2.6
=a=	2	3	1	A197144	A197145	3.8
=a=	2	4	1	A197146	A197147	4.9
=a=	3	1	1	A197148	A197149	1.6
=a=	3	2	1	A197150	A197151	2.8
=a=	1/2	3	1	A197152	A197153	3.1
=a=	1/2	4	1	A197154	A197155	4.2
#--------------------------------
# A214992 Power ceiling-floor sequence of (golden ratio)^4.
#b=	x .....	p1.....	p2.....	p3.....	p4.....	Limit
=b=	r......	A000045	A000045	A000045	A000045	r
=b=	r^2....	A001519	A001654	A061646	A001906	-1+S(5)
=b=	r^3....	A024551	A001076	A015448	A049652	-1+S(5)
=b=	r^4....	A049685	A157335	A214992	A004187	-19+9*S(5)
=b=	r^5....	A214993	A049666	A015457	A214994	.(-9+5*S(5))/2
=b=	r^6....	A007805	A156085	A214995	A049660	-151+68*S(5)
=b=	1+S(2).	A024537	A000129	A001333	A048739	S(2)
=b=	2+S(2).	A007052	A214996	A214997	A007070	(1+S(2))/2
=b=	1+S(3).	A057960	A002605	A028859	A077846	(1+S(3))/2
=b=	2+S(3).	A001835	A109437	A214998	A001353	-4+3*S(3)
=b=	S(5)...	A214999	A215091	A218982	A218983	1.26879683...
=b=	2+S(5).	A024551	A001076	A015448	A049652	-1+S(5)
=b=	2+S(6).	A218984	A090017	A123347	A218985	S(3/2)
=b=	2+S(7).	A218986	A015530	A126473	A218987	(1+S(7))/3
=b=	2+S(8).	A218988	A057087	A086347	A218989	(1+S(2))/2
=b=	3+S(8).	A001653	A084158	A218990	A001109	-13+10*S(2)
=b=	3+S(10)	A218991	A005668	A015451	A218992	-2+S(10)
#--------------------------------
