...
# perl extract_info.pl -pnr $(DIR)/ajson > asprog.txt
...
INSERT INTO $tabname VALUES('A000000', 'jOEIS-lite', 1, 'timestamp', '', 'GFis', CURRENT_TIMESTAMP, 1);
COMMIT;
GFis
} # print_create_asprog
#-----------------------
...
INSERT INTO $tabname VALUES('A000000', 0, 0, '', 0, 0, 'system', '', 'GFis', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
COMMIT;
GFis
} # print_create_asinfo
#-----------------------
...
INSERT INTO $tabname VALUES('A000000', 'A' || SUBSTR(CURRENT_DATE, 3,2) || SUBSTR(CURRENT_DATE, 6, 2) || SUBSTR(CURRENT_DATE, 9,2), 0);
COMMIT;
GFis
} # print_create_asinfo
#----
...
INSERT INTO $tabname VALUES('A000000', 0, 0, 0, '', '', 0, 0, 'system', CURRENT_TIMESTAMP);
COMMIT;
GFis
} # print_create_bfinfo
#------------------------------------
