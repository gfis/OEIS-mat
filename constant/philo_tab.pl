...
while (<DATA>) {
    ...
    if (0) {
        ...
        &output1($ans[2], $C);
        &output1($ans[3], $P);
    } elsif ($opt eq "=2=") { # centroid, with derivative, Nsolve -> nyi
        &output2($ans[0], $a, $b, $ans[4]);
    }
} # while <DATA>
#----
sub output1 {
...
sub output2 {
    my ($aseqno, $a, $b, $lo) = @_;
    if ($aseqno =~ m{\AA[0-9]}) {
        print join("\t", $aseqno, "parmof4", 1, "A195304", "$a", "$b", "$lo") . "\n";
    }
} # output2
__DATA__
...
=2=	3      	4      	5      	A195304    	A195305    	A105306    	A195411	1.1	1.1	1.1	1.1
=2=	5      	12     	13     	A195412    	A195413    	A195414    	A195424	1.7	1.1	1.1	1.1
=2=	7      	24     	25     	A195425    	A195426    	A195427    	A195428	2.4	1.1	1.1	1.1
=2=	8      	15     	17     	A195429    	A195430    	A195431    	A195432	2.9	1.1	1.1	1.1
=2=	1      	1      	r'2    	A195433    	A179587  	A195433    	A195436	0.4	1.1	1.1	1.1	1+A179587!
=2=	1      	2      	r'5    	A195434    	A195435    	A195444    	A195445	0.3	1.1	1.1	1.1
=2=	1      	3      	r'10   	A195446    	A195447    	A195448    	A195449	0.3	1.1	1.1	1.1
=2=	2      	3      	r'13   	A195450    	A195451    	A195452    	A195453	0.7	1.1	1.1	1.1
=2=	r'2    	r'3    	r'5    	A195454    	A195455    	A195456    	A195457	0.5	1.1	1.1	1.1
=2=	1      	r'2    	r'3    	A195471    	A195472    	A195473    	A195474	0.3	1.1	1.1	1.1
=2=	1      	r'3    	2      	A195475    	A195476    	A195477    	A195478	0.3	1.1	1.1	1.1
=2=	2      	r'5    	3      	A195479    	A195480    	A195481    	A195482	0.8	1.1	1.1	1.1
=2=	r'2    	r'5    	r'7    	A195483    	A195484    	A195485    	A195486	0.9	1.1	1.1	1.1
=2=	r'7    	3      	4      	A195487    	A195488    	A195489    	A195490	1.8	1.1	1.1	1.1
=2=	1      	r'phi  	phi    	A195491    	A195492    	A195493    	A195494	0.6	1.1	1.1	1.1
=2=	(phi-1)	phi    	r'3    	A195495    	A195496    	A195497    	A195498	0.4	1.1	1.1	1.1
