...
UPDATE seq4 SET offset =  1 WHERE aseqno IN ('A199618');
COMMIT;
-- TAB=d
...
UPDATE seq4 SET offset =  0 WHERE aseqno IN ('A198128','A198366');
UPDATE seq4 SET offset =  1 WHERE aseqno IN ('A198129');
COMMIT;
-- TAB=e
UPDATE seq4 SET offset =  1 WHERE aseqno IN ('A198840');
COMMIT;
-- TAB=f
